...
export function darken(b: RGB, s: RGB): RGB {
  return [
    Math.round(_clamp(darkenChannel(b[0] / 255, s[0] / 255) * 255)),
    Math.round(_clamp(darkenChannel(b[1] / 255, s[1] / 255) * 255)),
    Math.round(_clamp(darkenChannel(b[2] / 255, s[2] / 255) * 255)),
  ]
}
