context('Components/Autocomplete', () => {
  it('should use key arrows', () => {
    cy.visit('http://localhost:9009/.workshop/frame/?path=/ui/components/autocomplete/custom')
  ...
  it('should trigger focus and blur', () => {
    cy.visit(
      'http://localhost:9009/.workshop/frame/?path=/ui/components/autocomplete/focus-and-blur'
    )
